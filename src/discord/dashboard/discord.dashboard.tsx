...
function DiscordControl() {
	...
	async function post() {
		...
		const data = { channelID: msg.channelID, content: parsed, runID: msg.runID };
	...
	return <Form>
		<Button className="float-end" onClick={sendToF("updateEvents", undefined)}>Update Discord Events</Button>
